...
/**
 * Class m180507_132739_2_key_author
 * @property \yii\db\Transaction $_transaction
 * @Github https://github.com/Hzhihua
 */
class m180507_132739_2_key_author extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        $this->runSuccess['addAutoIncrement'] = $this->addAutoIncrement('{{%author}}', 'id', 'integer', 'unsigned', 2);
